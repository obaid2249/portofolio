...
export function Button({
    ...
    return (
        ...
        >
            ...
            <div
                className={cn("relative bg-slate-900/[0.8] border border-slate-800 backdrop-blur-xl text-white flex items-center justify-center text-sm antialiased", className)}
                style={{
